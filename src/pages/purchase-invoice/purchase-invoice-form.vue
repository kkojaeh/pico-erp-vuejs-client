  ...
  export default {
    ...
    data() {
      return {
        ...
        itemArray: new PurchaseInvoiceItemArray(),
        unitLabelArray: new UnitLabelArray(),
        statusLabelArray: new PurchaseInvoiceStatusArray()
      }
    },
    async mounted() {
      await Promise.all([
    ...
    methods: {
      ...
      async create() {
        ...
        this.itemArray = new PurchaseInvoiceItemArray(this.model)
      ...
      async load(id) {
        const model = await PurchaseInvoiceModel.get(id)
        const itemArray = new PurchaseInvoiceItemArray(model)
