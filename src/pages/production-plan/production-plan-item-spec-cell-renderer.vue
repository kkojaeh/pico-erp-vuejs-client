<template>
  <div class="row items-center fit production-plan-item-spec-cell-renderer">
    <div class="production-plan-item-spec-cell-renderer-label">{{value}}</div>
...
<style lang="stylus">
  .production-plan-item-spec-cell-renderer-label
    text-overflow: ellipsis
    overflow: hidden

  .production-plan-item-spec-cell-renderer
