    ...
    <c-list-view ref="listView" :array="array" :filters="filters" pagination class="col-grow"
      ...
      <ag-grid ref="grid"
        ...
        <ag-grid-column field="code" header-name="생산지시번호" :width="120"
                        ...
                        :cell-renderer-params="{path:'/production-execution/order/${id}', query:$route.query}"/>
        <ag-grid-column field="project.name" header-name="프로젝트명" :width="120" suppress-sorting/>
        <ag-grid-column field="item.code" header-name="품목 코드" :width="150" suppress-sorting/>
        <ag-grid-column field="item.name" header-name="품목 이름" :width="150" suppress-sorting/>
        ...
        <ag-grid-column field="receiveSite.name" header-name="인수지" :width="120" suppress-sorting/>
...
<script>
  ...
  import {ProductionOrderAwaitExecutionPaginationArray} from 'src/model/production-order'
  ...
  export default {
    ...
    data() {
      return {
        array: new ProductionOrderAwaitExecutionPaginationArray(),
