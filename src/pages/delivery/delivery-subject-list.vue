    ...
    <c-list-view ref="listView" :array="array" :filters="filters" pagination class="col-grow"
      ...
      <ag-grid ref="grid"
        ...
        <ag-grid-column field="id" header-name="아이디" :width="200"
                        ...
                        :cell-renderer-params="{path:'/delivery-subject/${id}', query:$route.query}"/>
...
<script>
  ...
  import {DeliverySubjectPaginationArray} from 'src/model/delivery'

  export default {
    data() {
      return {
        array: new DeliverySubjectPaginationArray(),
        subjectTypeArray: [],
        filters: {
          name: null
        },
